...
"""
================================================================================
  V8 雙向（多單/空單）75%勝率策略回測引擎 (75% Win Rate Matrix Search Engine V8)
  
  用途：以極速 pandas/numpy 載入 auto_export 中的個股數據，
        各自獨立執行 180 種多單與 180 種空單策略組合之矩陣回測，
        嚴格篩選出勝率 >= 75% 且交易次數 >= 5、整體 ROI >= 60.0% 的最佳組合，
        將結果寫入 leaderboard_v8.json，並將所有成交明細寫入 trades_v8.json。
================================================================================
"""
...
OUTPUT_LEADERBOARD_PATH = os.path.join(SCRIPT_DIR, "修正版_V6_Server", "public", "leaderboard_v8.json")
OUTPUT_TRADES_PATH = os.path.join(SCRIPT_DIR, "修正版_V6_Server", "public", "trades_v8.json")
...
def main():
    print("=" * 60)
    print("  [Start] 75% Win Rate Matrix Search Engine V8 starting...")
    print("=" * 60)
